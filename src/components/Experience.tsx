...
//           <div className="text-center mb-16 backdrop-blur-sm relative z-10">
...
//                     className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`} style={{zIndex: 5}}>
...
const Experience = () => {
  const experiences = [
    ...
    {
      title: 'Software Development Engineer (IC2)',
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-blue-400 to-emerald-400 mx-auto mb-6"></div>
            <p className="text-gray-300 max-w-2xl mx-auto">
              My journey in gaining practical experience through research, apprenticeship, and full-time opportunities.
            </p>
          </div>

          <div className="relative">
            {/* Timeline line - moved to left */}
            <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-400 to-emerald-400"></div>
            
            <div className="space-y-12">
              {experiences.map((experience, index) => (
                <div key={index} className="relative">
                  {/* Timeline dot - positioned on left */}
                  <div className="absolute left-1 w-10 h-10 rounded-full overflow-hidden bg-white z-10 flex items-center justify-center shadow-md border border-blue-300">
                    <img src={experience.logo} alt={`${experience.organization} logo`} className="w-10 h-10 object-contain" />
                  </div>

                  {/* Experience Card - full width with left margin */}
                  <div className="ml-16 relative" style={{zIndex: 5}}>
                    <div className="bg-gray-700/50 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border border-gray-600/30">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-2">
                          {getIcon(experience.type)}
                          <span className="text-sm font-medium text-gray-400">{experience.period}</span>
